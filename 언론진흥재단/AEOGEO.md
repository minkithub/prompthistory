...
: 바뀐 정보 탐색으로 인해 웹사이트를 통해 트래픽을 얻어온 언론 산업의 근간이 구조적으로 흔들리고 있음
: 사용자에게 노출되기 위해서는 AI에 먼저 노출되는 것이 중요. 그래서 중요성이 급부상한 AEO, GEO
: 이번 기고문을 통해 언론사들의 AEO, GEO 대비 현황을 visibilty 측정 실험으로 살펴보고자 함.
